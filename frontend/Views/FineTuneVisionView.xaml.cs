...
//                     SelectedZipPath = result.FullPath; // This should trigger label update
//                     _selectedZipLabel.Text = $"Selected folder: {Path.GetFileName(SelectedZipPath)}"; // Explicitly update the label here
...
//                         if (result != null && result.TryGetValue("dataset_id", out var datasetIdObj))
//                         {
//                             DatasetId = datasetIdObj?.ToString(); // Update the DatasetId property
//                             Dispatcher.Dispatch(async () =>
//                             {
...
namespace frontend.Views
{
    public partial class FineTuneVisionView : ContentView, INotifyPropertyChanged
    {
        ...
        //             // Update the path and label
        //             SelectedZipPath = result.FullPath; // This should trigger the label update
                    ...
                    FileTypes = new FilePickerFileType(new Dictionary<DevicePlatform, IEnumerable<string>>
            {
                ...
                if (result != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(DatasetId))
                    {
                        ...
                        // If confirmed, delete the old dataset folder
        ...
        //     try
        //     {
        //         // Delete old dataset folder before uploading a new one
        //         DeleteOldDatasetFolder();
