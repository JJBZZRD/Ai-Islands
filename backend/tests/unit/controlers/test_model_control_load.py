...
def test_load_model_success(mock_model_control, model_info_library, mock_torch):
    mock_model_control._get_model_info = Mock(return_value=model_info_library)
...
def test_load_model_file_not_found(mock_model_control, model_info_library):
    model_info_library['is_online'] = False
    model_info_library['dir'] = '/nonexistent/path'
    mock_model_control._get_model_info = Mock(return_value=model_info_library)
    mock_model_control._get_model_class = Mock()
...
def test_load_model_error_response(mock_model_control, model_info_library, mock_torch):
    mock_model_control._get_model_info = Mock(return_value=model_info_library)
    mock_model_control._get_model_class = Mock()
    mock_process = Mock()
    mock_process.start = Mock()
...
def test_load_model_unexpected_response(mock_model_control, model_info_library, mock_torch):
    mock_model_control._get_model_info = Mock(return_value=model_info_library)
    mock_model_control._get_model_class = Mock()
    mock_process = Mock()
    mock_process.start = Mock()
